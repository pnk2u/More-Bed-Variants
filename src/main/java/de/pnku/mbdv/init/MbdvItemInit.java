...
public class MbdvItemInit {
    ...
    public static final BlockItem BOUND_BAMBOO_WHITE_BED_I = itemFromBlock(BOUND_BAMBOO_WHITE_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_WHITE_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_WHITE_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_ORANGE_BED_I = itemFromBlock(BOUND_BAMBOO_ORANGE_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_ORANGE_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_ORANGE_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_MAGENTA_BED_I = itemFromBlock(BOUND_BAMBOO_MAGENTA_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_MAGENTA_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_MAGENTA_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_LIGHT_BLUE_BED_I = itemFromBlock(BOUND_BAMBOO_LIGHT_BLUE_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_LIGHT_BLUE_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_LIGHT_BLUE_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_YELLOW_BED_I = itemFromBlock(BOUND_BAMBOO_YELLOW_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_YELLOW_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_YELLOW_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_LIME_BED_I = itemFromBlock(BOUND_BAMBOO_LIME_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_LIME_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_LIME_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_PINK_BED_I = itemFromBlock(BOUND_BAMBOO_PINK_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_PINK_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_PINK_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_GRAY_BED_I = itemFromBlock(BOUND_BAMBOO_GRAY_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_GRAY_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_GRAY_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_LIGHT_GRAY_BED_I = itemFromBlock(BOUND_BAMBOO_LIGHT_GRAY_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_LIGHT_GRAY_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_LIGHT_GRAY_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_CYAN_BED_I = itemFromBlock(BOUND_BAMBOO_CYAN_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_CYAN_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_CYAN_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_PURPLE_BED_I = itemFromBlock(BOUND_BAMBOO_PURPLE_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_PURPLE_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_PURPLE_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_BLUE_BED_I = itemFromBlock(BOUND_BAMBOO_BLUE_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_BLUE_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_BLUE_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_BROWN_BED_I = itemFromBlock(BOUND_BAMBOO_BROWN_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_BROWN_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_BROWN_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_GREEN_BED_I = itemFromBlock(BOUND_BAMBOO_GREEN_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_GREEN_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_GREEN_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_RED_BED_I = itemFromBlock(BOUND_BAMBOO_RED_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_RED_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_RED_BED);
    ...
    public static final BlockItem BOUND_BAMBOO_BLACK_BED_I = itemFromBlock(BOUND_BAMBOO_BLACK_BED);
    public static final BlockItem STRIPPED_BOUND_BAMBOO_BLACK_BED_I = itemFromBlock(STRIPPED_BOUND_BAMBOO_BLACK_BED);
    ...
    public static void registerBedItems() {
        ...
        // BROWN
        registerOtherBedItem(ACACIA_BROWN_BED_I); registerOtherBedItem(BAMBOO_BROWN_BED_I); registerOtherBedItem(BOUND_BAMBOO_BROWN_BED_I); registerOtherBedItem(STRIPPED_BOUND_BAMBOO_BROWN_BED_I); registerOtherBedItem(BIRCH_BROWN_BED_I); registerOtherBedItem(CHERRY_BROWN_BED_I); registerOtherBedItem(CRIMSON_BROWN_BED_I); registerOtherBedItem(DARK_OAK_BROWN_BED_I); registerOtherBedItem(PALE_OAK_BROWN_BED_I); registerOtherBedItem(JUNGLE_BROWN_BED_I); registerOtherBedItem(MANGROVE_BROWN_BED_I); registerOtherBedItem(SPRUCE_BROWN_BED_I); registerOtherBedItem(WARPED_BROWN_BED_I);
        // RED
